...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("channel")
        .setDescription("Set or update the channel dedicated for confession broadcast.")
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addUserOption((option) =>
          option
            .setName("user")
            .setDescription("This user will be mentioned while broadcasting this confession.")
            .setRequired(false)
        )
    ),
    ...
    switch (subcommand) {
      ...
      default:
        await interaction.editReply({
          content: "Unknown subcommand. Please use `/confession channel` or `/confession create`.",
          ephemeral: true,
        });
    }
  },
